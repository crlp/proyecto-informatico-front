...
export class ParametroUtil {
    ...
    public static URL_BASE              = "http://localhost:8090/api"
    ...
    public static IMG_DEFAULT  = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8BQDwAEhQGAhKmMIQAAAABJRU5ErkJggg=="
    ...
    public static STATUS_CANC  = "CANCELADO"
